...
Mapped onto the enforceability classes of §12: **substrate trust → Class A**; **hallucination → Class C**; **alignment/honesty → Class C**; **robustness/OOD → B-avg/B-wc** (bounded shift) / **Class C** (open world). Only substrate trust is Class A — one cell of the table. The per-cluster reading (with why each lands where it does):
