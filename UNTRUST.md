...
> _Note: the changelog entries below reference section numbers as they stood when each entry was written (pre-v1.0.0). The v1.0.0 refactor renumbered every section — see the old→new map in B.2.7._
