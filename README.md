...
- `UNTRUST.md` — the document itself. Current version 0.3.0.
- `README.md` — this file.
...
4. §0.6 — fifth enforcement pattern, added v0.3.0. Connects to §1–§2.
...
- **Patch (0.x.y)** — clarifications, typos, citation fixes. No content change.
